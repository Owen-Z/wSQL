...
public interface MysqlQueryVisitor<T> extends ParseTreeVisitor<T> {
	/**
	 * Visit a parse tree produced by {@link MysqlQueryParser#dbName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDbName(MysqlQueryParser.DbNameContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MysqlQueryParser#datatype}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDatatype(MysqlQueryParser.DatatypeContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MysqlQueryParser#createcolumnlist}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCreatecolumnlist(MysqlQueryParser.CreatecolumnlistContext ctx);
	/**
	 * Visit a parse tree produced by {@link MysqlQueryParser#colname_and_type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitColname_and_type(MysqlQueryParser.Colname_and_typeContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MysqlQueryParser#valuelist}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitValuelist(MysqlQueryParser.ValuelistContext ctx);
	/**
